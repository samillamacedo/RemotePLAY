...
//define buttons
var buttons = [
  new Button("FF6897", ["0", "y", "z", "_"]),
  new Button("FF30CF", ["1", "+", "-", "*"]),
  new Button("FF18E7", ["2", "a", "b", "c", "d"]),
  new Button("FF7A85", ["3", "e", "f"]),
  new Button("FF10EF", ["4", "g", "h", "i"]),
  new Button("FF38C7", ["5", "j", "k", "l"]),
  new Button("FF5AA5", ["6", "m", "n", "o"]),
  new Button("FF42BD", ["7", "p", "q", "r"]),
  new Button("FF4AB5", ["8", "s", "t", "u"]),
  new Button("FF52AD", ["9", "v", "w", "x"]),
